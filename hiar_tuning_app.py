...
DATABASE_REF = {
    "YAMAHA (MATIC)": {
        "Karbu": {
            "115cc": {
                "Mio / Soul 115": {
                    "bore": 50.0, "stroke": 57.9, "v_head": 13.7,
                    "valve_in": 23.0, "valve_out": 19.0, "venturi": 24.0,
                    "hp_std": 8.78, "peak_rpm": 8000, "limit_std": 9000,
                    "weight_std": 92.0, "valves": 2, "lift_std": 7.0, "dur_std": 230
                }
            },
            "125cc": {
                "Xeon (Carb)": {
                    "bore": 52.4, "stroke": 57.9, "v_head": 14.5,
                    "valve_in": 26.0, "valve_out": 21.0, "venturi": 26.0,
                    "hp_std": 10.7, "peak_rpm": 8500, "limit_std": 9500,
                    "weight_std": 103.0, "valves": 2, "lift_std": 7.5, "dur_std": 235
                }
            }
        },
        "Injeksi": {
            "125cc": {
                "Mio Fino 125 FI": {
                    "bore": 52.4, "stroke": 57.9, "v_head": 14.2,
                    "valve_in": 25.5, "valve_out": 21.0, "venturi": 24.0,
                    "hp_std": 9.5, "peak_rpm": 8000, "limit_std": 9500,
                    "weight_std": 98.0, "valves": 2, "lift_std": 7.8, "dur_std": 235
                }
            },
            "155cc": {
                "NMAX 155 / Aerox": {
                    "bore": 58.0, "stroke": 58.7, "v_head": 14.6,
                    "valve_in": 20.5, "valve_out": 17.5, "venturi": 28.0,
                    "hp_std": 15.09, "peak_rpm": 8000, "limit_std": 9500,
                    "weight_std": 127.0, "valves": 4, "lift_std": 8.2, "dur_std": 240
                }
            },
            "250cc": {
                "XMAX 250": {
                    "bore": 70.0, "stroke": 64.9, "v_head": 22.5,
                    "valve_in": 26.5, "valve_out": 22.5, "venturi": 32.0,
                    "hp_std": 22.5, "peak_rpm": 7000, "limit_std": 9000,
                    "weight_std": 179.0, "valves": 4, "lift_std": 8.5, "dur_std": 245
                }
            }
        }
    },
    "HONDA (MATIC)": {
        "Karbu": {
            "110cc": {
                "Beat 110 Karbu": {
                    "bore": 50.0, "stroke": 55.0, "v_head": 11.8,
                    "valve_in": 25.5, "valve_out": 21.0, "venturi": 22.0,
                    "hp_std": 8.22, "peak_rpm": 8000, "limit_std": 9000,
                    "weight_std": 89.0, "valves": 2, "lift_std": 7.0, "dur_std": 230
                },
                "Vario 110 Karbu": {
                    "bore": 50.0, "stroke": 55.0, "v_head": 11.5,
                    "valve_in": 25.5, "valve_out": 21.0, "venturi": 24.0,
                    "hp_std": 8.99, "peak_rpm": 8000, "limit_std": 9000,
                    "weight_std": 99.0, "valves": 2, "lift_std": 7.2, "dur_std": 230
                }
            }
        },
        "Injeksi": {
            "110cc": {
                "Beat 110 FI (eSP)": {
                    "bore": 50.0, "stroke": 55.1, "v_head": 12.0,
                    "valve_in": 25.5, "valve_out": 21.0, "venturi": 22.0,
                    "hp_std": 8.68, "peak_rpm": 7500, "limit_std": 9300,
                    "weight_std": 93.0, "valves": 2, "lift_std": 7.2, "dur_std": 232
                }
            },
            "125cc": {
                "Vario 125 eSP": {
                    "bore": 52.4, "stroke": 57.9, "v_head": 14.2,
                    "valve_in": 25.5, "valve_out": 21.0, "venturi": 24.0,
                    "hp_std": 11.1, "peak_rpm": 8500, "limit_std": 9500,
                    "weight_std": 111.0, "valves": 2, "lift_std": 7.8, "dur_std": 235
                }
            },
            "150cc": {
                "Vario 150 / PCX 150": {
                    "bore": 57.3, "stroke": 57.9, "v_head": 15.6,
                    "valve_in": 29.0, "valve_out": 23.0, "venturi": 26.0,
                    "hp_std": 12.92, "peak_rpm": 8500, "limit_std": 9800,
                    "weight_std": 109.0, "valves": 2, "lift_std": 8.0, "dur_std": 235
                }
            },
            "160cc": {
                "Vario 160 / PCX 160": {
                    "bore": 60.0, "stroke": 55.5, "v_head": 12.8,
                    "valve_in": 23.0, "valve_out": 19.5, "venturi": 28.0,
                    "hp_std": 15.4, "peak_rpm": 8500, "limit_std": 10000,
                    "weight_std": 115.0, "valves": 4, "lift_std": 8.5, "dur_std": 245
                }
            }
        }
    }
...
def needle_gauge_html(label, value, max_value, unit, redline=None, optimal_low=None, optimal_high=None, size=360):
    ...
    <div style="width:100%; max-width:{size}px; margin:auto; background:#050505; border:1px solid #333; border-radius:22px; padding:14px 14px 18px 14px; box-shadow:0 10px 40px rgba(0,0,0,.35);">
      ...
      <div style="position:relative; width:100%; aspect-ratio:1/1;">
        <svg viewBox="0 0 400 400" width="100%" height="100%">
          ...
          <g transform="rotate({angle:.1f} 200 200)" style="transition: transform 0.22s cubic-bezier(0.2, 0.9, 0.2, 1); filter:url(#glow);">
      ...
      <div style="display:flex; justify-content:space-between; gap:8px; margin-top:4px;">
        <div style="flex:1; height:10px; border-radius:8px; background:#1d3f63;"></div>
        <div style="flex:1; height:10px; border-radius:8px; background:#1b5c2d;"></div>
        <div style="flex:1; height:10px; border-radius:8px; background:#5b2b16;"></div>
        <div style="flex:1; height:10px; border-radius:8px; background:#7a1212;"></div>
      </div>
    </div>
    """


def render_audio_once(rpm_now, redline, file_candidates=None):
    if file_candidates is None:
        file_candidates = ["assets/superbike_loop.mp3", "superbike_loop.mp3", "engine_loop.mp3"]
...
def build_line_graph(runs, current_idx=None, current_rpm=None, current_hp=None, current_nm=None):
    fig = go.Figure()
    colors = ["rgba(255, 0, 0, 1)", "rgba(0, 255, 0, 1)", "rgba(0, 0, 255, 1)", "rgba(255, 255, 0, 1)", "rgba(255, 0, 255, 1)", "rgba(0, 255, 255, 1)"]

    for i, r in enumerate(runs):
        color = colors[i % len(colors)]
        opacity = 0.18 if i < len(runs) - 1 else 0.92
        width = 2 if i < len(runs) - 1 else 3
        dash = "dot" if i < len(runs) - 1 else "solid"
    ...
    if current_idx is not None and runs:
        current = runs[current_idx]
        color = colors[current_idx % len(colors)]
        fig.add_trace(go.Scatter(x=current["rpms"][: current["live_pos"] + 1], y=current["hps"][: current["live_pos"] + 1], line=dict(color=color, width=5), showlegend=False))
...
def calculate_engine_metrics(cc, bore, stroke, cr, rpm_limit, valve_in, n_valve_in, valve_out, n_valve_out, lift, venturi, dur_in, dur_out, afr, material, drivetrain, std):
    ...
    hps, torques, vel_in_list, vel_out_list = [], [], [], []
...
def drag_profile(hp_max, weight_total, idle=1800.0):
...
with st.sidebar:
    ...
    with st.expander("🛠️ Engine Input", expanded=True):
        ...
        in_n_v_in = st.selectbox("Jml Klep In", [1, 2, 4], index=1 if std["valves"] >= 4 else 1)
        in_v_out = st.number_input(f"Klep Out (std: {std['valve_out']})", value=float(std["valve_out"]), step=0.1)
        in_n_v_out = st.selectbox("Jml Klep Out", [1, 2, 4], index=1 if std["valves"] >= 4 else 1)
...
# Standby visual ketika belum klik apa pun
if not (run_dyno_btn or run_drag_btn) and not st.session_state.dyno_history and not st.session_state.drag_history:
    ...
    c1, c2 = st.columns(2)
    with c1:
        components.html(needle_gauge_html("Tachometer", 0, max(float(in_rpm) + 1500.0, 1500.0), "RPM", float(in_rpm), 1500.0, max(1800.0, float(in_rpm) * 0.92)), height=430)
    with c2:
        components.html(needle_gauge_html("Speedometer", 0, 120, "km/h", 100, 20, 80), height=430)
...
# =========================================================
if run_dyno_btn:
    st.session_state.last_mode = "dyno"
    ...
    with m1: st.metric("Gas Speed In", f"{latest['Velocity']:.2f} m/s")
    with m2: st.metric("Gas Speed Out", f"{latest['Velocity_Out']:.2f} m/s")
    with m3: st.metric("Piston Speed", f"{latest['PistonSpeed']:.2f} m/s")
    with m4: st.metric("CC", f"{latest['CC']:.2f}")
    with m5: st.metric("CR", f"{latest['CR']:.2f}")
    ...
    # satu run saja: idle -> warmup -> sweep -> limiter -> idle 3 detik -> off
    idle_frames = [0] * 6
    warmup_frames = list(np.linspace(0, 1800, 8))
    sweep_frames = list(np.linspace(1800, latest["RPM_HP"], 18))
    hold_frames = [latest["RPM_HP"]] * 5
    top_frames = list(np.linspace(latest["RPM_HP"], float(in_rpm), 10))
    limiter_frames = []
    for _ in range(4):
        limiter_frames += [float(in_rpm) * 0.97, float(in_rpm), float(in_rpm) * 1.01, float(in_rpm) * 0.985]
    down_frames = list(np.linspace(float(in_rpm), 1800, 8))
    idle_end_frames = [1800] * 6
    off_frames = list(np.linspace(1800, 0, 6))
    anim_rpms = idle_frames + warmup_frames + sweep_frames + hold_frames + top_frames + limiter_frames + down_frames + idle_end_frames + off_frames

    for idx, rpm_now in enumerate(anim_rpms):
        current_rpm = max(float(rpm_now), 0.0)
        hp_now = float(np.interp(current_rpm, latest["rpms"], latest["hps"]))
        nm_now = float(np.interp(current_rpm, latest["rpms"], latest["torques"]))
        speed_max = max(120.0, 60.0 + latest["Max_HP"] * 5.0)
        speed_now = clamp((current_rpm / max(float(latest["rpms"][-1]), 1.0)) * speed_max, 0.0, speed_max)
        live_pos = min(int((current_rpm / max(float(latest["rpms"][-1]), 1.0)) * (len(latest["rpms"]) - 1)), len(latest["rpms"]) - 1)

        tach_html = needle_gauge_html("Tachometer", current_rpm, max(float(in_rpm) + 1500.0, 1500.0), "RPM", float(in_rpm), 1500.0, max(1800.0, float(in_rpm) * 0.92))
        speed_html = needle_gauge_html("Speedometer", speed_now, speed_max, "km/h", speed_max * 0.82, speed_max * 0.35, speed_max * 0.68)

        with gauge_left:
            components.html(tach_html, height=430)
        with gauge_mid:
            components.html(speed_html, height=430)

        live_graph = build_line_graph(st.session_state.dyno_history, current_idx=len(st.session_state.dyno_history)-1, current_rpm=current_rpm, current_hp=hp_now, current_nm=nm_now)
        if idx % 2 == 0:
        ...
        if idx < 6:
            ...
            render_audio_once(current_rpm, float(in_rpm))
        elif current_rpm < float(in_rpm):
            render_audio_once(current_rpm, float(in_rpm))

        if current_rpm <= 0:
            time.sleep(0.12)
        elif current_rpm < 1800:
            time.sleep(0.08)
        elif current_rpm < float(latest["RPM_HP"]):
            time.sleep(0.05)
        elif current_rpm < float(in_rpm):
            time.sleep(0.04)
        else:
    ...
    # idle 3 detik lalu off
    for _ in range(12):
        with gauge_left:
            components.html(needle_gauge_html("Tachometer", 1800, max(float(in_rpm) + 1500.0, 1500.0), "RPM", float(in_rpm), 1500.0, max(1800.0, float(in_rpm) * 0.92)), height=430)
        with gauge_mid:
            components.html(needle_gauge_html("Speedometer", 0, max(120.0, 60.0 + latest["Max_HP"] * 5.0), "km/h", max(120.0, 60.0 + latest["Max_HP"] * 5.0) * 0.82, 20, 80), height=430)
        time.sleep(0.22)
...
# =========================================================
if run_drag_btn:
    st.session_state.last_mode = "drag"
    ...
    st.session_state.drag_history.append(run)
    ...
    # idle singkat lalu full run 0-1000m
    for _ in range(int(idle_time * 10)):
        with tach_ph:
            components.html(needle_gauge_html("Tachometer", 1800, max(float(in_rpm) + 1500.0, 1500.0), "RPM", float(in_rpm), 1500.0, max(1800.0, float(in_rpm) * 0.92)), height=430)
        with speed_ph:
            components.html(needle_gauge_html("Speedometer", 0, max(120.0, run["Max Speed"] * 1.15), "km/h", max(120.0, run["Max Speed"]) * 0.82, 40, 110), height=430)
        time.sleep(0.12)
    ...
    for i in range(n_frames + 1):
        p = i / n_frames
        dist = 1000.0 * p
        # speed curve: awal kuat, tengah stabil, ujung naik lagi
        speed_now = run["Max Speed"] * (1.0 - math.exp(-3.1 * p))
        speed_now = clamp(speed_now + 4.0 * math.sin(p * math.pi), 0.0, run["Max Speed"])
        rpm_now = clamp(1800.0 + (float(in_rpm) - 1800.0) * (speed_now / max(run["Max Speed"], 1e-9)) ** 0.95, 1800.0, float(in_rpm))
        hp_now = hp_max * (0.55 + 0.45 * p)
        nm_now = hp_now * 7127.0 / max(rpm_now, 1.0)

        tach_html = needle_gauge_html("Tachometer", rpm_now, max(float(in_rpm) + 1500.0, 1500.0), "RPM", float(in_rpm), 1500.0, max(1800.0, float(in_rpm) * 0.92))
        speed_html = needle_gauge_html("Speedometer", speed_now, max(120.0, run["Max Speed"] * 1.15), "km/h", max(120.0, run["Max Speed"]) * 0.82, 40, 110)
        with tach_ph:
            components.html(tach_html, height=430)
        with speed_ph:
            components.html(speed_html, height=430)
        ...
        graph.update_layout(
            ...
            yaxis=dict(title="Speed (km/h)", range=[0, max(120.0, run["Max Speed"] * 1.15)], showgrid=True, gridcolor="#333"),
            paper_bgcolor="#050505",
            plot_bgcolor="#050505",
        ...
        render_audio_once(rpm_now, float(in_rpm))
        time.sleep(max(total_time / n_frames, 0.03))
...
if st.session_state.dyno_history:
    st.header("📊 Performance Dyno Result")
    df = pd.DataFrame(st.session_state.dyno_history)
...
if st.session_state.drag_history:
    st.markdown("<div style='height:10px'></div>", unsafe_allow_html=True)
    st.header("🏁 Drag Simulation Predictions")
    df_drag = pd.DataFrame(st.session_state.drag_history)
    df_drag = df_drag[["Run", "0-100m", "0-201m", "0-402m", "0-1000m", "Max Speed"]].rename(
        columns={"0-100m": "100m", "0-201m": "201m", "0-402m": "402m", "0-1000m": "1000m", "Max Speed": "Max Speed (km/h)"}
    )
    st.dataframe(
        df_drag.style.format({"100m": "{:.2f}s", "201m": "{:.2f}s", "402m": "{:.2f}s", "1000m": "{:.2f}s", "Max Speed (km/h)": "{:.1f}"}),
        hide_index=True,
        use_container_width=True,
    )
